...
const Services = () => {
	...
	const [state] = useState({
		...
		subHeading: 'Our aim is to provide professioonal and unique services to customers, and we have provided high quality services to our customers that why they love travel friends.',
	})
	return (
